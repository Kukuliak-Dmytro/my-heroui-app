          ...
          <ul className="flex items-center gap-3 sm:gap-4">
            <li>
              <Button
                ...
                variant="ghost"
                radius="sm"
                className="text-xs sm:text-sm lg:text-base px-2 sm:px-4">
                Log In
              </Button>
            </li>
            <li>
